        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                    onClick={fetchEvents}
                    disabled={loading}
                    className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700/50 rounded-lg transition"
                >
                    ...
                    {availableSportTypes.map(type => (
                        <button
                            ...
                            className={`px-3 py-1.5 text-sm rounded-full transition flex items-center gap-1.5 ${activeFilter === type
                                ...
                                : 'bg-slate-100 text-slate-500 border border-slate-200 hover:border-slate-300 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-700 dark:hover:border-slate-600'
                                }`}
                        >
